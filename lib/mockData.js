...
export const transitTimeMatrix = [
  { from: 'Delhi', to: 'Panipat', etaHours: 4 },
  { from: 'Delhi', to: 'Lucknow', etaHours: 10 },
  { from: 'Delhi', to: 'Patna', etaHours: 20 },
  { from: 'Ludhiana', to: 'Jammu', etaHours: 9 },
  { from: 'Panipat', to: 'Patna', etaHours: 18 },
];

export const documentCenter = [
  { title: 'Conditions of Carriage', file: 'Conditions_of_Carriage.pdf' },
  { title: 'Bill of Lading (BOL)', file: 'Bill_of_Lading.pdf' },
  { title: 'Terms & Conditions', file: 'Terms_and_Conditions.pdf' },
];
